...
const Register = () => {
  ...
  const {register: registerUser, error: registerError, loading: registerLoading} = useAuthStore();
  ...
  const onSubmit = async (data) => {
    try{
      ...
      if(response?.success){
        ...
        setBackendError(response?.message || 'Error al registrarse el usuario')
      }
            ...
            <div className="flex w-screen h-screen">
              ...
              <div className="w-full md:w-7xl p-54 flex flex-col justify-center items-center bg-zinc-800 text-white">
                ...
                <form className="w-full max-w-md" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  >
                    {isSubmitting || registerLoading ? 'Registrando...' : 'Crear cuenta'}
                  </button>
                </form>
