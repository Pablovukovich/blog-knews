...
export const RoseMarcas = ({marcas, cardVariants}) => {
  return (
    <>
        <div className="relative min-h-screen w-full  overflow-hidden">
        {/* Fondo difuminado */}
        <img
          src="/rose/rose-background-2.jpg"
          alt="fondo marcas"
          ...
          {marcas.map((marca, i) => (
            ...
            >
              <a href="#" target="_blank" rel="noopener noreferrer">
                ...
                />
                {/* Overlay */}
                <div className="absolute inset-0 bg-[#A64B5B]/30 group-hover:bg-transparent transition-all duration-300" />
                {/* Texto centrado */}
