...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    autor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Knews'>;
...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'categoria'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiComentarioComentario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<
      ['pendiente', 'aprobado', 'rechazado', 'spam']
    > &
      Schema.Attribute.DefaultTo<'aprobado'>;
    likes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDeadlineEventDeadlineEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'deadline_events';
  info: {
    description: '';
    displayName: 'DeadlineEvent';
    pluralName: 'deadline-events';
    singularName: 'deadline-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    estadio: Schema.Attribute.String & Schema.Attribute.Required;
    fecha: Schema.Attribute.Date;
    horario: Schema.Attribute.Time;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::deadline-event.deadline-event'
    > &
      Schema.Attribute.Private;
    paisEstado: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDestacadoDestacado extends Struct.SingleTypeSchema {
  ...
  attributes: {
    articulosDestacados: Schema.Attribute.Relation<
      'oneToMany',
      'api::articulo.articulo'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiGlobalConfGlobalConf extends Struct.SingleTypeSchema {
  collectionName: 'global_confs';
  info: {
    displayName: 'global-conf';
    pluralName: 'global-confs';
    singularName: 'global-conf';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_coment: Schema.Attribute.Relation<
      'oneToMany',
      'api::comentario.comentario'
    >;
    username: Schema.Attribute.String &
